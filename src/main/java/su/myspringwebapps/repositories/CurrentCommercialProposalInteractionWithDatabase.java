...
public class CurrentCommercialProposalInteractionWithDatabase implements CurrentCommercialProposalInteractionWithDatabaseInterface {
    ...
    private static List<DoorPosition> listCurrentCommencialProposal = new ArrayList<DoorPosition>();

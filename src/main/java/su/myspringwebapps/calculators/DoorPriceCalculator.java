...
@Service
public class DoorPriceCalculator implements IDoorPriceCalculator {
    ...
    public long calculatePrice(DoorPosition currentDoorPosition, DoorPrice currentDoorPrice, Long totalNumberOfDoors) {
        ...
        finalPrice += calculateByDoorTrim(
                ...
                (currentDoorPosition.getTwoDoorLeafs().equals("нет") ? number_stick_box_2_5 : number_stick_box_3_0));
